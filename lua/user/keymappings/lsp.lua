...
Nvim.keys.normal_mode['<leader>V']     = {
  "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>",
...
Nvim.keys.normal_mode["<"]          = { function() diagnostic_jump(-1) end, { desc = "goto prev diagnostic", nowait = true } }
Nvim.keys.normal_mode[">"]          = { function() diagnostic_jump(1) end, { desc = "goto next diagnostic", nowait = true } }
