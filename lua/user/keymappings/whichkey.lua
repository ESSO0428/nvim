...
Nvim.which_key = {
  ...
  { "<leader>dmr", "<cmd>lua require('neotest').run.run(vim.fn.expand('%'))<cr>",                     desc = "Test Run File" },
  { "<leader>dmR", "<cmd>lua require('neotest').run.run({vim.fn.expand('%'), strategy = 'dap'})<cr>", desc = "Test Run File DAP" },
  { "<leader>dmm", "<cmd>lua require('neotest').run.run()<cr>",                                       desc = "Test Method" },
  { "<leader>dmM", "<cmd>lua require('neotest').run.run({strategy = 'dap'})<cr>",                     desc = "Test Method DAP" },
  { "<leader>dmc", "<cmd>lua require('neotest').run.run({vim.fn.expand('%')})<cr>",                   desc = "Test Class" },
  { "<leader>dmC", "<cmd>lua require('neotest').run.run({vim.fn.expand('%'), strategy = 'dap'})<cr>", desc = "Test Class DAP" },
  { "<leader>dmn", "<cmd>lua require('neotest').run.run()<cr>",                                       desc = "Test Run Nearest" },
  { "<leader>dmN", "<cmd>lua require('neotest').run.run({strategy = 'dap'})<cr>",                     desc = "Test Nearest DAP" },
  { "<leader>dml", "<cmd>lua require('neotest').run.run_last()<cr>",                                  desc = "Test Run Last" },
  { "<leader>dmL", "<cmd>lua require('neotest').run.run_last({ strategy = 'dap' })<cr>",              desc = "Test Run Last DAP" },
  { "<leader>dmo", "<cmd>lua require('neotest').output.open({ enter = true })<cr>",                   desc = "Test Output" },
  { "<leader>dmS", "<cmd>lua require('neotest').run.stop()<cr>",                                      desc = "Test Stop" },
  { "<leader>dms", "<cmd>lua require('neotest').summary.toggle()<cr>",                                desc = "Test Summary" },
