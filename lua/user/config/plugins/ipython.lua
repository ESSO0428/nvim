...
Nvim.select_current_nvim_jupyter_kernel_in_current_buffer = select_current_nvim_jupyter_kernel_in_current_buffer
...
Nvim.keys.normal_mode['<leader>sq'] = { select_current_nvim_jupyter_kernel_in_current_buffer,
  desc = "Check Jupyter Kernel (Current nvim)" }
