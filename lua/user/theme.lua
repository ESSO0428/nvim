...
vim.cmd "hi link @variable.parameter.python @parameter.python"
vim.cmd "hi link @function.builtin.python @function.call.python"
vim.cmd "hi link @function.method.python @function.call.python"
vim.cmd "hi link @lsp.typemod.function.defaultLibrary.python @function.call.python"
vim.cmd "hi link @lsp.type.selfParameter.python @variable.builtin.python"
vim.cmd "hi link @attribute.python @function.call.python"
vim.cmd "hi @keyword.function.python guifg=#569cd6"
vim.cmd "hi link @keyword.type.python @boolean.python"
...
vim.cmd "hi link @text.title.4.marker Title"
vim.cmd "hi link markdownH4Delimiter Title"
vim.cmd "hi! link RenderMarkdownH1Bg DiffAdd"
vim.cmd "hi! link RenderMarkdownH2Bg DiffChange"
vim.cmd "hi! link RenderMarkdownH3Bg DiffDelete"
vim.cmd "hi! link RenderMarkdownH4Bg DiffDelete"
vim.cmd "hi! link RenderMarkdownH5Bg DiffDelete"
vim.cmd "hi! link RenderMarkdownH6Bg DiffDelete"
